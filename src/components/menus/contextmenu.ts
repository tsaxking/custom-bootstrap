...
import { CBS_H6 } from "../0-text/header.ts";
import { CBS_Paragraph } from "../0-text/paragraph.ts";
 ...
 */
export type CBS_ContextmenuSections = {
 ...
 */
export type CBS_ContextmenuSelectOptions = CBS_Options & {
    color?: CBS_Color;
    name: string;
}
 ...
 */
export type CBS_ContextmenuOptions = CBS_Options & {
    color?: CBS_Color;
